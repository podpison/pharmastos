...
export const AboutUs: React.FC = () => {
  return <div className="aboutUs">
    <div className="aboutUs__descriptionContainer">
      ...
      <p className="aboutUs__companyDescription">Мы специализируемся на поставках современных качественных и профессионально подобранных медецинских изделий. В настоящее время компания занимает лидирующие позиции на рынках оптовых продаж одноразовых медецинских изделий.</p>
    </div>
